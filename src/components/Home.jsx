...
// import animation_lmgbumni from '../assets/animation_lmgbumni.json'
        ...
        <div className='my-container flex flex-col items-center justify-between lg:flex-row'>
            ...
            <div className='mb-10 lg:max-w-lg lg:pr-5 lg:mb-0'>
                ...
                <div className='flex flex-col items-center md:flex-row'>
                    ...
                    <Link
                        to='/about'
                        className='inline-flex items-center font-semibold text-orange-600 transition-colors duration-200 hover:text-orange-700'
                    >
                        Learn More
                    </Link>
